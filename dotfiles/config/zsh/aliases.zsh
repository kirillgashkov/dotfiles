...
alias git-clone-with-filter='git clone --filter=blob:none'
...
alias dcab="docker compose --profile '*' build"
alias dcad="docker compose --profile '*' down"
alias dcadv="docker compose --profile '*' down -v"
alias dcal="docker compose --profile '*' logs"
alias dcalf="docker compose --profile '*' logs -f"
alias dcau="docker compose --profile '*' up"
alias dcaud="docker compose --profile '*' up -d"
alias dcap="docker compose --profile '*' ps"
alias dcapa="docker compose --profile '*' ps -a"
